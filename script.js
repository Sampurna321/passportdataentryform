...
function copyToClipboard() {
  ...
  var textToCopy = document.getElementsByClassName("textToCopy")[0]; // Assuming there's only one element with the class "textToCopy"
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    var dobAD = document.getElementById("dobAD").value;
    var dobBS = document.getElementById("dobBS").value;
    var villagename = document.getElementById("villagename").value;
    var wardno = document.getElementById("wardno").value;
    var phonenumber = document.getElementById("phonenumber").value;
    var displayParagraph = document.getElementById("displayData");
    displayParagraph.innerHTML =
      "नाम: " +
      name.toUpperCase() +
"<br>Date of birth (AD):    " + dobAD +
"<br>Date of birth (BS):    " + dobBS +
"<br>बुवाको नाम (English मा) :    <br>" + fathername.toUpperCase() +
"<br>आमाको नाम (English मा) :    <br>" + mothername.toUpperCase() +
"<br>नेपालमा कोही एकजनाको फोन नम्बर:    <br>" + phonenumber +
"<br>प्रदेशको नाम:    " + first.value +
"<br>जिल्लाको नाम:    " + second.value +
"<br>महानगर/नगरपालिका वा गाउँपालिकाको नाम:    " + third.value +
"<br>वडा नम्बर:    " + wardno +
"<br>टोलको नाम:    " + villagename.toUpperCase() +
"<br>Next of Kin:    " + nextofkin.toUpperCase() +
"<br>माथि लेखिएको Information हरु चेक गर्नुहोला।"
  });
